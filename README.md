Tweet Marker is a web service for setting and getting the "last read" tweet for a given Twitter user. It can be used to sync the reading position between multiple Twitter clients and platforms.
